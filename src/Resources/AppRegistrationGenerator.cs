...
az ad app delete --id ${appRegistration.ApplicationIdentifierUriVariable}";
        ...
        public string GenerateEnvScript() => $@"{appRegistration.ApplicationIdVariable}=`az ad app show --id ""${appRegistration.ApplicationIdentifierUriVariable}"" --query appId -o tsv`";
